...
class DataPeminjamController extends Controller
{
    ...
    public function destroy($id){
        $cari_user_id = DataPeminjam::where('id', $id)->pluck('user_id');
        $use_id = User::where('id', $cari_user_id);
        $user_id->update();
        $data_peminjam = DataPeminjam::find($id);
    ...
    public function collection_wherein(){
        $collection = DataPeminjam::all()->whereIn('kode_peminjam',['P0001','P0002']);
        return $collection;
    }
    ...
    public function collection_tojson(){
        $data = [
            ['kode_peminjam' => 'P0001', 'nama_peminjam' => 'Kalil'],
            ['kode_peminjam' => 'P0002', 'nama_peminjam' => 'Anwar'],
            ['kode_peminjam' => 'P0003', 'nama_peminjam' => 'Irwan'],
        ];
