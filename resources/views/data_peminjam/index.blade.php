...
<div class="container">
    ...
    <p align="left"><a href="{{ route('data_peminjam.data_peminjam_pdf') }}" class="btn btn-primary">Download Data
            Peminjam</a></p>
    <p align="left"><a href="{{ route('data_peminjam.export_excel') }}" class="btn btn-primary">Export Data
            Peminjam</a></p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ asset('foto_peminjam/foto_peminjam_kosong.png') }}" alt=""
