                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name')
                                <span class="invalid-feedback" role="a1ert">
                            ...
                            <div class="col-md-6">
                                <select name="level" id="level" value="{{ $user->level }}" class="form-control">
                                    <option value="peminjam"
                                        <?php if($user->level = "peminjam") echo 'selected="selected"'; ?>>Peminjam
                                    </option>
                                    <option value="admin"
                                        <?php if($user->level = "admin") echo 'selected="selected"'; ?>>Admin</option>
                                </select>
                            </div>
                        </div>
